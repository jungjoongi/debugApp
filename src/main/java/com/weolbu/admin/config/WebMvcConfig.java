...
import com.weolbu.admin.config.auth.LoginUserArgumentResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private final com.weolbu.admin.config.interceptor.ResponseInterceptor ResponseInterceptor;
